window.onload = function() {
        ...
        $add_img.on('click', function() {
                ...
                $('.xiaoji').text('共' + $goods_num + '件商品  小计：￥' + '元');
                console.log(parseFloat(($('.xiaoji').text())); count_switch = true;
                });
            ...
            //日期选择器
            //datepicker,日期选择器
            var start_mon, start_day, end_mon, end_day; $('.get_good_time').click(function(event) {
                var _this = this;
                weui.datePicker({
                    start: new Date(),
                    end: 2030,
